...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        #                           alpha	t	tolerance
        # ϵ=pow(alpha,t),for 0<a<1	0.96000	150	0.00219
        # ϵ=1/(t^2)	                0.00000	100	0.00010
        # ϵ=pow(e,-at),for 0<a<1	0.05000	100	0.00674
        # ϵ=pow(alpha,t),for 0<a<1	0.88	50	0.00168 -> converge faster: only 50 trials return A+ Safety and A Reliability


        if not testing:
            print "self.epsilon: ", self.epsilon
            # self.epsilon -= .05
            # print "Updated epsilon using a decay function(self.epsilon -= .05): ", self.epsilon
            ...
            self.epsilon = 0
            self.alpha = 0
            print "testing -> set epsilon and alpha to 0:"
    ...
    def createQ(self, state):
        ...
        if self.learning:
            if state not in self.Q:
                ...
                self.Q[state] = { 'right':0, 'forward':0, 'left': 0, None:0}
    ...
    def choose_action(self, state):
        ...
        #     maxActions = [act for act in self.Q[state] if self.Q[state][act] == maxVal]
...
def run():
    ...
    agent = env.create_agent(LearningAgent, alpha = 0.95, epsilon = 1, learning = True)
    ...
    sim.run(n_test = 20, tolerance = 0.00127)
